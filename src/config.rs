...
//     pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = Default::default();
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "HAN123han".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["jipv4.123cf.top"];
pub const RS_PUB_KEY: &str = "fH7Wxq31U9rURcA2IOPMw9QmdnBB4MEAH43BFm3AjX0=";
...
impl UserDefaultConfig {
    ...
    pub fn get(&self, key: &str) -> String {
        match key {
            ...
            keys::OPTION_ACCESS_MODE => self.get_string(key, "full", vec!["view", "edit"]),
